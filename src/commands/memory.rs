...
pub trait MemoryCommands<T: ErrorType> {
    ...
    fn convert_temperature(&mut self) -> Result<(), AError<T::Error>>;

    /// Signals the mode of DS18B20 power supply to the master.
    fn read_power_supply(&self) -> Result<(), AError<T::Error>>;
